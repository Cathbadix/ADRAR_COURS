...
Générateur de citation
    ...
    */
let buttonSelector = document.querySelector("#button-next-js");
buttonSelector = addEventListener("click", refreshCitation);
...
function refreshCitation(){
    ...
    swap = citation;
    document.querySelector(".p1").textContent = arrayOfQuotes[citation][0];
    document.querySelector(".p2").textContent = arrayOfQuotes[citation][1];         
}
refreshCitation();
...
//console.log(arrayOfQuotes[0][0]); affiche "Mamamia"